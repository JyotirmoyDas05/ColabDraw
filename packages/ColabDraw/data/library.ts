...
const ALLOWED_LIBRARY_URLS = [
  ...
  "raw.githubusercontent.com/excalidraw/excalidraw",
  "raw.githubusercontent.com/JyotirmoyDas05/ColabDraw",
];
...
export const useHandleLibrary = (
  opts: {
     ...
     * If not supplied, only the placeholder.colabdraw.app base domain is allowed.
     */
